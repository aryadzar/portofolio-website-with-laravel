              ...
              <div class="row">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('upload_post')}}" id="updateForm" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                  <textarea type="text" class="tinymce-editor" height="50%"  name="isi" required>{{ old('isi')}}</textarea>
                                </div>
                              </div>
